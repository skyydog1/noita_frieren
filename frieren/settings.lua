...
local mod_id = "frieren" -- This should match the name of your mod's folder.
mod_settings_version = 1 -- This is a magic global that can be used to migrate settings to new mod versions. call mod_settings_get_version() before mod_settings_update() to get the old value. 
mod_settings = 
{
	{
		category_id = "group_of_settings",
		ui_name = "Character Select",
		ui_description = "I'm Frierening it :)",
		settings = {
			{
				id = "char",
				ui_name = "Character",
				ui_description = "Funny placeholder text here",
				value_default = "Frieren",
				values = { {"frieren","Frieren"}, {"fern","Fern"} },
